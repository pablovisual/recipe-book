...
const Page = () => {
  return (
    <div className='flex flex-row p-4 h-[87vh]'>
      ...
      <div className="w-[70%] grid grid-cols-3 gap-4 content-evenly max-h-screen overflow-auto scrollbar-none flex-grow">
        {recipes.map((recipe) => (
          <div key={recipe.id} className="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-300">
            <a className='' href="#">
